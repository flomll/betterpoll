	...
	<tr>
		<td>
			<div align="center">
				...
				&nbsp;
				<input type="button" name="option" class="button" value="<?php echo JText::_('Results'); ?>" onclick="document.location.href='<?php echo JRoute::_("index.php?option=com_mfpolls&id=$poll->slug".$itemid); ?>'" />
			</div>
		</td>
	</tr>
</table>
